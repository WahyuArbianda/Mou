...
--
-- Host: 127.0.0.1
-- Generation Time: 11 Jun 2019 pada 05.56
...
('1', 1, 'admin@gmail.com', 'superadmin', 'superadmin', '12345678', 'superadmin', 'admin'),
('21CAK', 20, 'adminpks@gmail.com', 'Admin PKS', 'Admin PKS', '854', 'Admin PKS', 'admin'),
...
--
ALTER TABLE `tipe_admin`
  MODIFY `id_tipe` int(2) NOT NULL AUTO_INCREMENT;
